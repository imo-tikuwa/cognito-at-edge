...
exports.Authenticator = exports.SUPPORTED_LANGUAGES = void 0;
...
class Authenticator {
    ...
    _verifyParams(params) {
        ...
        if (params.language !== undefined && !exports.SUPPORTED_LANGUAGES.includes(params.language)) {
            throw new Error(`Expected params.language to be one of: ${exports.SUPPORTED_LANGUAGES.join(', ')}`);
        }
    }
    /**
